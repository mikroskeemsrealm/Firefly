...
function savePatches {
    ...
    git format-patch --no-stat --zero-commit --full-index --no-signature -N -o "$basedir/${what_name}-Patches/" upstream/upstream >/dev/null
    cd "$basedir"
...
savePatches "Waterfall/Waterfall-Proxy" "MikroCord-Proxy"
)
